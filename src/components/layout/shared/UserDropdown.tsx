...
const UserDropdown = () => {
  ...
  if (!session) {
    return (
      <Box className="flex items-center plb-2 pli-6 gap-2" tabIndex={-1}>
        <Avatar alt="" src="" />
            ...
            <Paper className={settings.skin === 'bordered' ? 'border shadow-none' : 'shadow-lg'}>
              <ClickAwayListener onClickAway={e => handleDropdownClose(e as MouseEvent | TouchEvent)}>
                <MenuList sx={{ paddingTop: '10px' }}>
                  ...
                  <MenuItem className='mli-2 gap-3' onClick={() => router.push(`/user/profile`)}>
