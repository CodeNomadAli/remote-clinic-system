...
import { validateRequest, successResponse, errorResponse } from "@/libs/api/utils";
import { aiAssistantSchema } from "@/libs/validations";
import { getAIDiagnosisSuggestion } from "@/libs/services/ai-assistant";
import { getPrismaClient, isDatabaseConfigured } from "@/libs/db/prisma";
